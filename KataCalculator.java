    ...
    private static void AnswerRoman(String significance, int a, int b) throws ArithmeticException {
        ...
        try {
            switch (significance) {
                ...
                case "-":
                	if (a - b == 0 || b - a == 0) {
                		System.err.println("В Римской системе ответ не может быть отрицательным или равен нулю.");
                	}
        ...
        if (tmpAnswer < 0) {
        	...
        	System.err.print("В Римской системе ответ не может быть отрицательным или равен нулю.");
